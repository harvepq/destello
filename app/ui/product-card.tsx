export default function ProductCard({name, image, items, prices, people, description}: any) {
  return (
    <div className="min-w-72 max-w-md shadow-[0px_0px_8px_2px_rgba(0,0,0,0.25)] rounded-xl overflow-hidden cursor-pointer sm:hover:scale-105">
      <picture>
      ...
      <div className="pb-3 pt-2 px-4">
        ...
        <button className="w-full bg-[#052659] text-white text-lg font-bold px-6 h-12 rounded-lg hover:bg-blue-900 my-4">Ver detalle</button>
